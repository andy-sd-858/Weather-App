var APIKey = "27437d490ea9d4f4312dceb15f39bbc2";
var city = "";
var currentDate = "";
var tempF = "";
var humidityValue = "";
...
var SearchedCitiesFromLS = JSON.parse(localStorage.getItem("searched-cities"));
if (SearchedCitiesFromLS !== null) {
  SearchedCitiesFromLS.forEach(function(city) {city.toUpperCase();});
  listOfSearchedCities = SearchedCitiesFromLS;  
}
...
function getColorCodeForUVIndex(uvIndex) {
  ...
  else if ((uvIndexValue > 7) && (uvIndexValue <= 9)) {
    colorcode = "#ff0000";
  }
